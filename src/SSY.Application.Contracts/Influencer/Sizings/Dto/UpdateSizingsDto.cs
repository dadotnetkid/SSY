...
public class UpdateSizingsDto:FullAuditedEntityDto<Guid>
{
    public UpdateSizingsDto()
    {

    }
    public UpdateSizingsDto(Guid userId,string toziUser, string toziId, string toziCode, string toziObj, decimal toziTopSize, decimal toziBottomSize, decimal toziDressSize, decimal toziHeight, decimal toziWeight, decimal neckGirth, decimal armLength, decimal shoulderLenth, decimal armholeGirth, decimal acrossFront, decimal acrossBack, decimal aboveBustGirth, decimal bustGirth, decimal chestWidth, decimal backWaistLength, decimal waistGirth, decimal lowWaistGirth, decimal lowerWaistGirth, decimal hipGirth, decimal crotchLength, decimal kneeGirth, decimal calfGirth, decimal inseamInLeg, decimal inseamInLegAngkle, decimal sideSeam)
    {
        UserId = userId;
        ToziUser = toziUser;
        ToziId = toziId;
