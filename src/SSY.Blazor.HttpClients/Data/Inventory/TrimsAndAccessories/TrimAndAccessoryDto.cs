...
{
    public class TrimAndAccessoryDataDto
    {
        [JsonPropertyName("result")]
        public TrimAndAccessoryResultsDto Result { get; set; }

    }
    public class TrimAndAccessoryResultsDto
    {
        [JsonPropertyName("totalCount")]
        public int TotalCount { get; set; }

        [JsonPropertyName("items")]
        public List<TrimAndAccessoryDto> Items { get; set; }
    }
    public class TrimAndAccessoryResultDto
    {
        [JsonPropertyName("result")]
        public TrimAndAccessoryDto Result { get; set; }

    }

    public class TrimAndAccessoryDto
    {
