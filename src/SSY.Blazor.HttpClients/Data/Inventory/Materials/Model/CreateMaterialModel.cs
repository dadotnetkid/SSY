...
namespace SSY.Blazor.HttpClients.Data.Inventory.Materials.Model
{
    public class CreateMaterialModel
    {
        ...
        public CreateAccountabilityModel Accountability { get; set; } = new();
        ...
        public List<CreateRollAndLocationModel> RollsAndLocations { get; set; }
        ...
        public CreateCompositionAndConstructionModel CompositionAndConstruction { get; set; }
