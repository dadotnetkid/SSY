namespace SSY.Blazor.Pages.Shared.Pages.Inventory.PurchaseOrder.PurchaseOrderOverview
{
    public partial class PurchaseOrderOverview
    {
        public PurchaseOrderOverview()
        {
        }
