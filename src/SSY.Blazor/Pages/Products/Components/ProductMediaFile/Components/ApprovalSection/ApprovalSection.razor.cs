...
using SSY.Blazor.HttpClients.Data.CollectionsAndProducts.Products.RejectionNotes;

namespace SSY.Blazor.Pages.Products.Components.ProductMediaFile.Components.ApprovalSection
{
